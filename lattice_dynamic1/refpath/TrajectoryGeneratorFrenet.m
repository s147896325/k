classdef TrajectoryGeneratorFrenet < handle
    ...
    methods
        ...
        function [frenetTrajectory,sv,dv,globalTrajectory] = connect(obj, initialState, terminalState, timeSpan)
        ...
        %       See also referencePathFrenet, trajectoryGeneratorFrenet
            ...
            [sv,dv,frenetTrajectory] = obj.connectPairs(f0, f1, obj.TimeResolution, tF);
    ...
    methods (Access = public, Static)
        function [sV,dV,trajectories] = connectPairs(f0,f1,dt,timespan)
        %connectPairs Connect N pairs of start/end states
            ...
            for trajIdx = 1:numTraj
                ...
                longitudinalTrajectories{trajIdx} = QuinticQuarticTrajectory(sV0,sV1,tFinal);
                ...
                % Fit quintic/quartic polynomial
                lateralTrajectories{trajIdx} = QuinticQuarticTrajectory(dV0,dV1,dsMax);
